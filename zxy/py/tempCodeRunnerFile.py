    ...
    while not FLAG and retries < 30:
        ...
        if not data:
            ...
            # 模式 4: 东校区图书馆三层自习室指定座位优先
                ...
                # 指定座位列表
                target_seats = ["132", "133", "144", "145", "156", "157", "168", "169", "180", "181", "192", "193", "204", "205", "216", "217", "228", "229", "240", "241", "252", "253", "264", "265"]
                # 优先座位列表
                priority_seats = ["192", "193", "204", "205", "216", "217", "228", "229"]
