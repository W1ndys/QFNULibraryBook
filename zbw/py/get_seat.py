...
# 导入 a.py 中的座位数据
import sys
sys.path.append('d:\\QFNULibraryBook-main')
from a import li1, li2, li3, li1_priority_seats, li2_priority_seats, li3_priority_seats
    ...
    while not FLAG and retries < 100:
        ...
        if not data:
            ...
            # 模式 4: 东校区图书馆三层自习室指定座位优先
                ...
                # 合并所有指定座位列表
                target_seats = li1 + li2 
                # 合并所有优先座位列表
                priority_seats = li1_priority_seats + li2_priority_seats
